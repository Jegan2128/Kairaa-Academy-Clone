...
export default function Blockchain_D() {
  return (
    <div>
      <div className="container mx-6 items-center mx-auto justify-between animate-fadeInUp">
          ...
          <div className="mx-10 grid md:grid-cols-2 items-center justify-between">
            <div className="items-center">
              ...
              <div className="md:mx-10 md:mb-10 md:px-2 text-lg leading-relaxed">
                ...
                <Link to="/pages/top/Blockchain/subfile/BCF"><button className="mt-4 md:ml-32 ml-25 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-bounce">View More</button></Link>
              </div>
          </div>
        </div>
      ...
      <div className="container ">
        <div className="mx-10 grid md:grid-cols-2 items-center *:justify-between animate-fadeInUp">
          ...
          <div className="md:mx-10 md:mb-10 md:px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Blockchain/subfile/BDP"><button className="mt-4 md:ml-32 ml-25 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-bounce">View More</button></Link>
          </div>
        </div>
        <hr className="mt-2 border-gray-400" />
      </div>
      ...
      <div className="container">
        <div className="mx-10 grid md:grid-cols-2 items-center *:justify-between animate-fadeInUp">
          ...
          <div className="md:mx-10 md:mb-10 md:px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Blockchain/subfile/BDE"><button className="mt-4 md:ml-32 ml-25 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-bounce">View More</button></Link>
          </div>
        </div>
      ...
      <div className="container">
        <div className="mx-10 grid md:grid-cols-2 items-center *:justify-between animate-fadeInUp">
          ...
          <div className="md:mx-10 md:mb-10 md:px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Blockchain/subfile/SSP"><button className="mt-4 md:ml-32 ml-25 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-bounce">View More</button></Link>
          </div>
        </div>
      ...
      <div className="container">
        <div className="mx-10 grid md:grid-cols-2 items-center justify-between animate-fadeInUp">
          ...
          <div className="md:mx-10 md:mb-10 md:px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Blockchain/subfile/CBT"><button className="mt-4 md:ml-32 ml-25 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-bounce">View More</button></Link>
          </div>
        </div>
      </div>
