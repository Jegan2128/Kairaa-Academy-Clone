...
import OverviewCPP from "../OverviewCPP";
import SyllabusCPP from "../SyllabusCPP";



export default function CPPtabs({
  tabs = [
    { id: "overview", label: "Overview", content:  <OverviewCPP /> },
    { id: "syllabus", label: "Syllabus", content: <SyllabusCPP/> },
  ],
    defaultIndex = 0,
    className = "",
  }) {
