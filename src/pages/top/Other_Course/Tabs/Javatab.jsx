...
import Overviewjava from "../Overviewjava";
import Syllabusjava from "../Syllabusjava";



export default function CPPtabs({
  tabs = [
    { id: "overview", label: "Overview", content:  <Overviewjava /> },
    { id: "syllabus", label: "Syllabus", content: <Syllabusjava/> },
  ],
    defaultIndex = 0,
    className = "",
  }) {
