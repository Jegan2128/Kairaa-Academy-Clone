...
import OverviewWebdev from "../OverviewWebdev";
import SyllabusWebdev from "../SyllabusWebdev";



export default function Webdevtabs({
  tabs = [
    { id: "overview", label: "Overview", content:  <OverviewWebdev /> },
    { id: "syllabus", label: "Syllabus", content: <SyllabusWebdev/> },
  ],
    defaultIndex = 0,
    className = "",
  }) {
