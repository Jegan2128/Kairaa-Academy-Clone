...
import Overviewmysql from "../Overviewmysql";
import Syllabusmysql from "../Syllabusmysql";



export default function Mysqltabs({
  tabs = [
    { id: "overview", label: "Overview", content:  <Overviewmysql/> },
    { id: "syllabus", label: "Syllabus", content: <Syllabusmysql/> },
  ],
    defaultIndex = 0,
    className = "",
  }) {
