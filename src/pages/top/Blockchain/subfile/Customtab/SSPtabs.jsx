...
import OverviewSSP from "../OverviewSSP";
import SyllabusSSP from "../SyllabusSSP";



export default function SSPTabs({
  tabs = [
    { id: "overview", label: "Overview", content:  <OverviewSSP /> },
    { id: "syllabus", label: "Syllabus", content: <SyllabusSSP /> },
   ],
    defaultIndex = 0,
    className = "",
  }) {
