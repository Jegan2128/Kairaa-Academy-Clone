...
import OverviewBDE from "../OverviewBDE";
import SyllabusBDE from "../SyllabusBDE";

export default function BDETabs({
  tabs = [
    { id: "overview", label: "Overview", content: <OverviewBDE /> },
    { id: "syllabus", label: "Syllabus", content: <SyllabusBDE /> },
  ],
  defaultIndex = 0,
  className = "",
}) {
