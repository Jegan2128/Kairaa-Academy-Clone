...
import OverviewBCF from "../OverviewBCF";
import SyllabusBCF from "../SyllabusBCF";


// Tailwind React Custom Tabs
// - Accessible (aria roles + keyboard navigation)
// - Animated moving indicator that measures tab widths
// - Fully styled with Tailwind (no external CSS)
// - Supports dynamic tab labels & panels via `tabs` prop

export default function CustomTabs({
  tabs = [
    { id: "overview", label: "Overview", content:  <OverviewBCF/> },
    { id: "syllabus", label: "Syllabus", content: <SyllabusBCF/> },
  ],
  defaultIndex = 0,
  className = "",
}) {
