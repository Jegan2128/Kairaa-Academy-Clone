import BCFtabs from "./Customtab/BCFtabs";
        ...
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row">
          <div className="md:w-3/4">
            <h2 className="font-sans font-bold text-white text-4xl py-3">
              Learn Fundemantals of Blockchain Development
            </h2>

            <p className="py-3 text-lg text-white font-bold">
              Learn about the fundamentals of blockchain development, relevant
              skills, and technical FAQ.
            </p>
