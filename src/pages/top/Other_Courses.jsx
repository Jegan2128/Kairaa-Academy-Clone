    ...
    <div className="animate-fadeInUp">
      ...
      <div>
        <div>
          ...
          <div className="mx-10 grid grid-cols-2 items-center justify-between">
            <div>
              <img
            ...
            <div className="mx-10 mb-10 px-2 text-lg leading-relaxed">
              ...
              <Link to="/pages/top/Other_Course/CPP"><button className="mt-4 ml-32 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-swing">
                View More
              </button></Link>
            </div>
          </div>
      ...
      <div className="container">
        <div className="mx-10 grid grid-cols-2 items-center justify-between">
          ...
          <div className="mx-10 mb-10 px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Other_Course/Webdev"><button className="mt-4 ml-32 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-swing">View More</button>
          </Link></div>
        </div>
        <hr className="mt-2 border-gray-400" />
      </div>
      ...
      <div className="container">
        <div className="mx-10 grid grid-cols-2 items-center justify-between">
          ...
          <div className="mx-10 mb-10 px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Other_Course/Java"><button className="mt-4 ml-32 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-swing">View More</button>
          </Link></div>
        </div>
        <hr className="mt-2 border-gray-400" />
      </div>
      ...
      <div className="container">
        <div className="mx-10 grid grid-cols-2 items-center justify-between">
          ...
          <div className="mx-10 mb-10 px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Other_Course/Php"><button className="mt-4 ml-32 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-swing">View More</button>
          </Link></div>
        </div>
        <hr className="mt-2 border-gray-400" />
      </div>
      ...
      <div className="container">
        <div className="mx-10 grid grid-cols-2 items-center justify-between">
          ...
          <div className="mx-10 mb-10 px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Other_Course/Flutters"><button className="mt-4 ml-32 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-swing">View More</button>
          </Link></div>
        </div>
        <hr className="mt-2 border-gray-400" />
      </div>
      ...
      <div className="container">
        <div className="mx-10 grid grid-cols-2 items-center justify-between">
          ...
          <div className="mx-10 mb-10 px-2 text-lg leading-relaxed">
            ...
            <Link to="/pages/top/Other_Course/Mysql"><button className="mt-4 ml-32 rounded-lg bg-gradient-to-r from-sky-400 to-pink-400 p-2 font-semibold text-white animate-swing">View More</button>
            </Link></div>
        </div>
    </div>
